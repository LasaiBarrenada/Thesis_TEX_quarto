...
% \includeonly{chapters/08_FundamentalProblem}

\begin{document}

\includepdf[pages=-, fitpaper=true]{Cover/CoverDigital.pdf}
...
\includepdf[pages=-, fitpaper=true]{Cover/BackCoverDigital2.pdf}
