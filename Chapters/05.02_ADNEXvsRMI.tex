...
\begin{tablenotes}
\footnotesize
\item ADNEX: Assessment of Different NEoplasias in the adneXa.
\end{tablenotes}
\end{table}
...
\item ADNEX, Assessment of Different NEoplasias in the adneXa; CI, confidence interval; PI, prediction interval; RMI, risk of malignancy index.
\end{tablenotes}
\end{table}
...
\item ADNEX, Assessment of Different NEoplasias in the adneXa; RMI, Risk of malignancy index.
\end{tablenotes}
\end{sidewaystable}
