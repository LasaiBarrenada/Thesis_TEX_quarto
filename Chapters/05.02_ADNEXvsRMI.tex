\chapter[ADNEX VS RMI]{Head-to-head comparison of the RMI and ADNEX models to estimate the risk of ovarian malignancy: a systematic review and meta-analysis of external validation studies}
% Only include if the thesis is written as a collection of papers
%_________________________
\includegraphics*[width=0.3\linewidth]{logos/BMJ.png}\vspace{0.5cm}
...
published as: 
\begin{quote}
Barreñada L, Ledger A, Kotlarz A, Dhiman P, Collins G, Wynants L, Verbakel JY, et al. Head-to-head comparison of the \gls{RMI} and \gls{ADNEX} models to estimate the risk of ovarian malignancy: a systematic review and meta-analysis of external validation studies. BMJ Open 2025;15:e104141. doi: 10.1136/bmjopen-2025-104141
\end{quote}
%_________________________
\section*{Abstract}
\textbf{Objectives:} Assessment of Different NEoplasias in the adneXa (\gls{ADNEX}) and
Risk of Malignancy Index (\gls{RMI}) are models that estimate the risk of malignancy in
ovarian masses based on clinical and ultrasound information. The aim is to perform a
meta-analysis of studies that compared the performance of the two models in the same
patients (`head-to-head comparison').

\textbf{Design:} Systematic review and meta-analysis.

\textbf{Data sources:} Systematic literature search from publication of \gls{ADNEX} model
(15/10/2014) up to 31/07/2024 in Embase, Web of Science, Scopus, Medline (via
PubMed) and EuropePMC.

\textbf{Eligibility criteria for selecting studies:} We included all studies that
externally validated the performance of \gls{ADNEX} (with or without CA125) and \gls{RMI} on
the same data.

\textbf{Data extraction and synthesis:} Two independent reviewers extracted data
using a standardised extraction sheet. We assessed risk of bias using \gls{PROBAST}. We
performed random effects meta-analysis of the area under the receiver operating
characteristic curve (\gls{AUC}), sensitivity, specificity and clinical utility (net
benefit, relative utility and probability of being useful in a hypothetical new
centre) at thresholds commonly used clinically (10\% risk of malignancy for \gls{ADNEX},
200 for \gls{RMI}).

\textbf{Results:} We included 11 studies comprising 8271 tumours. Most studies were
at high risk of bias. The summary \gls{AUC} to distinguish benign from malignant tumours
in operated patients for \gls{ADNEX} with CA125 was 0.92 (95\% \gls{CI} 0.90 to 0.94) and for
\gls{RMI} it was 0.85 (0.81 to 0.89). Sensitivity and specificity for \gls{ADNEX} with CA125
were 0.93 (0.90 to 0.96) and 0.77 (0.71 to 0.81) and for \gls{RMI}, they were 0.61 (0.56
to 0.67) and 0.92 (0.89 to 0.94). The probability of the test being useful in a
hypothetical new centre in operated patients was 96\% for \gls{ADNEX} with CA125 and 15\%
for \gls{RMI} at the selected thresholds.

\textbf{Conclusions:} \gls{ADNEX} has better discrimination and clinical utility than \gls{RMI}.
...
completeness of reporting, quality of methodology and risk of bias. The extraction
...
Or Diagnosis) and \gls{PROBAST} (Prediction model Risk of Bias Assessment Tool) tools
...
using package ``metamisc'' for \gls{AUC}, ``meta'' and ``mada'' for sensitivity and
specificity, and rjags for \gls{NB} and \gls{RU}. Bayesian methods for meta-analysis of clinical
utility were computed using \gls{JAGS} version 4.3.0.

\section{Results}

Thirteen studies presented results for both \gls{ADNEX} and \gls{RMI}
...
\gls{OSF} repository (https://osf.io/nt89z/).

\begin{table}
\centering
\includegraphics[width=1\textwidth]{figures/ADNEXvsRMI/T1.png}
...
validation of \gls{ADNEX}, and 17.18 (61\%) \gls{TRIPOD} items for the validation of \gls{RMI}. The
...
with missing data (Figure~\ref{fig:2:1}). Most validations were unclear in the predictors domain
...
\begin{figure}
\centering
\includegraphics[width=0.8\textwidth]{figures/ADNEXvsRMI/F1.png}
...
except one \cite{behnamfarComparisonUltrasoundTumor2022}.

\subsection{Meta-analyses}
Results of the meta-analysis of \gls{AUC} are shown in Table~\ref{tab:2:2}. Seven studies included in
...
\begin{table}
\centering
\includegraphics[width=1\textwidth]{figures/ADNEXvsRMI/T2.png}
...
\begin{figure}
\centering
\includegraphics[width=0.8\textwidth]{figures/ADNEXvsRMI/F2.png}
...
Table~\ref{tab:2:3}. Eight studies included in the meta-analysis compared the sensitivity and
...
\begin{table}
\centering
\includegraphics[width=1\textwidth]{figures/ADNEXvsRMI/T3.png}
...
\begin{figure}
\centering
\includegraphics[width=0.8\textwidth]{figures/ADNEXvsRMI/F3.png}
...
\begin{table}
\centering
\includegraphics[width=1\textwidth]{figures/ADNEXvsRMI/T4.png}
\caption[Meta-analysis for clinical utility]{Meta-analysis for clinical utility of ADNEX and RMI.}
\label{tab:2:4}
\end{table}
...
consistent findings. Funnel plots for \gls{AUC} did not suggest publication bias.
...
reference librarians of the KU Leuven Libraries (2Bergen, Learning Centre Désiré
Collen, Leuven, Belgium) for their help in conducting the systematic literature
...
repository (https://osf.io/nt89z/) \cite{barrenadaOSFADNEXVs2024}. All data
