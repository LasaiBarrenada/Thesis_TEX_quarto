...
\label{tab:2:1}
\begin{tabularx}{0.7\textwidth}{lrl}
\toprule
...
\bottomrule
\addlinespace[0.5em]
\multicolumn{2}{l}{ADNEX: Assessment of Different NEoplasias in the adneXa.}
\end{tabularx}
\end{table}
...
\bottomrule
\addlinespace[0.5em]
\multicolumn{9}{l}{ADNEX, Assessment of Different NEoplasias in the adneXa; CI, confidence interval; PI, prediction interval; RMI, risk of malignancy index.}
\end{tabularx}
\end{table}
