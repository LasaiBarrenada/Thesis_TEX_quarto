...
published as: 
\begin{quote}
 \textbf{Barreñada L}, Ledger A, Kotlarz A et al. Head-to-head comparison of the RMI and ADNEX models to estimate the risk of ovarian malignancy: a systematic review and meta-analysis of external validation studies. BMJ Open 2025;15:e104141. doi: 10.1136/bmjopen-2025-104141
\end{quote}
\vspace{-0.5em}
...
\section*{Summary}
We extended the systematic review and meta-analysis of external validations of the ADNEX model
 \cite{barrenadaADNEXRiskPrediction2024} to perform a head-to-head comparison of the performance of the ADNEX and RMI models. We included 11 studies with 8271 tumours. The performance of ADNEX was better than that of RMI in terms of discrimination and clinical utility. The probability of the test being useful in a hypothetical new centre in operated patients was 96\% for ADNEX with CA125 and 15\% for RMI at the 10\%  threshold. The results support the use of ADNEX instead of RMI for triaging patients with ovarian tumours for referral to an oncology centre.
...
\centering
\small
\caption[Characteristics of included studies]{Characteristics of the eleven included studies. ADNEX, Assessment of Different NEoplasias in the adneXa.}
\label{tab:2:1}
\begin{tabular}{lrl}
\toprule
\textbf{Study characteristics} & \textbf{N (\%)} \\
\midrule
...
\label{tab:2:2}
\begin{tabularx}{\textwidth}{Xlrrccccc}
\toprule
...
& ADNEX & 4668 & 7 & 26 & 0.92 & 0.90--0.94 & 0.82--0.99 & 0.30 \\
& RMI   & 4668 & 7 & 26 & 0.85 & 0.81--0.89 & 0.64--0.98 & 0.44 \\
\addlinespace
\multicolumn{9}{l}{\textbf{For ADNEX without CA125}} \\
& ADNEX & 3773 & 4 & 22 & 0.92 & 0.90--0.94 & 0.85--0.97 & 0.16 \\
& RMI   & 3773 & 4 & 22 & 0.87 & 0.84--0.89 & 0.78--0.94 & 0.12 \\
\addlinespace
\multicolumn{9}{l}{\textbf{Target population: operated and conservatively managed patients}} \\
\addlinespace
\multicolumn{9}{l}{\textbf{For ADNEX with CA125}} \\
& ADNEX & 4905 & 1 & 17 & 0.93 & 0.91--0.96 & 0.85--0.99 & 0.27 \\
& RMI   & 4905 & 1 & 17 & 0.89 & 0.86--0.92 & 0.77--0.97 & 0.22 \\
\addlinespace
\multicolumn{9}{l}{\textbf{For ADNEX without CA125}} \\
& ADNEX & 4905 & 1 & 17 & 0.94 & 0.93--0.96 & 0.88--0.99 & 0.26 \\
& RMI   & 4905 & 1 & 17 & 0.89 & 0.86--0.92 & 0.77--0.97 & 0.22 \\
\bottomrule
\end{tabularx}
\end{table}
