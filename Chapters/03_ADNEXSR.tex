...
WAlthough our findings suggest that ADNEX is clinically useful, well conducted validations of any model are always of value to monitor its performance in diverse regions and clinical settings, and over time \cite{vancalsterThereNoSuch2023}. To improve the performance of ADNEX even more, efforts to update the ADNEX formula are of interest \cite{vancalsterThereNoSuch2023,
