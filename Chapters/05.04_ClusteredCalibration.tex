...
\footnotesize
\raggedleft
\item Note: Implementation in the code included in the OSF. For the implementation in \textit{CalibrationCurves} package go to the package documentation.
\end{tablenotes}
\end{sidewaystable}
...
\footnotesize
\raggedleft
\item \textsuperscript{a}Deciles are calculated only with 10 points instead of 100.
\end{tablenotes}
\end{sidewaystable}
