...
published as:
\begin{quote}
\textbf{Barre\~{n}ada L}, De Cock Campo B, Wynants L \& Van Calster B. Clustered flexible calibration plots for binary outcomes using random effects modeling. \textit{Research Synthesis Methods}. 2025;1--22. \url{https://doi.org/10.1017/rsm.2025.10046}
\end{quote}
\begin{quote}
...
\label{tab:4:2}
\begin{tabular}{rrrr llllll}
\toprule
 & \textbf{N.} & & & \textbf{Standard flexible} & & & & & \\
\textbf{EPC} & \textbf{Cent} & \textbf{ICC} & \textbf{AUC} & \textbf{logistic} & \textbf{CG-C group}\textsuperscript{a} & \textbf{CG-C interval}$^a$ & \textbf{2MA-C splines} & \textbf{2MA-C LOESS} & \textbf{MIX-C} \\
\midrule
...
\toprule
 & \textbf{N.} & & & \textbf{Standard flexible} & & & & & \\
\textbf{EPC} & \textbf{Cent} & \textbf{ICC} & \textbf{AUC} & \textbf{logistic} & \textbf{CG-C group}$^a$ & \textbf{CG-C interval}$^a$ & \textbf{2MA-C splines} & \textbf{2MA-C LOESS} & \textbf{MIX-C} \\
\midrule
...
\setlength{\tabcolsep}{4pt}
\begin{threeparttable}
\caption[Median MSCE for center-specific results in the synthetic data]{Median MSCE for the synthetic data study for center-specific results. MSCE is presented multiplied by 100. Bold numbers indicate best performance across approaches. The center-specific true curves are based on a flexible logistic model with restricted cubic splines.}
\label{tab:4:4}
\begin{tabular}{rr lll lll}
\toprule
