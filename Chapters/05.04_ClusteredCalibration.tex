...
\bottomrule
\addlinespace[0.5em]
\multicolumn{6}{l}{\textbf{Note}: Implementation in the code included in the OSF. For the implementation in \textit{CalibrationCurves} package go to the package documentation.}
\end{tabularx}
\end{threeparttable}
\end{sidewaystable}
