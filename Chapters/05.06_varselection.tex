...
\centering
\small
\caption{IOTA variable selection comparison.}
...
\bottomrule
\multicolumn{6}{l}{\small Note: VS = procedure, BE = backward elimination, Fam hist = family history, Pap = papillary projections, MSD = max solid diameter, Adj = adjusted} \\
\end{tabularx}
